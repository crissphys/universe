...
function loadIndex(){
 ...
 if(!indexPromise)indexPromise=Promise.all([
  fetch('/universe-ui/data/platform.json?v=20260924-lumbreras-covers').then(r=>r.json()),
...
translate();
const {startPlatform}=await import('./platform.js?v=20260924-lumbreras-covers');
