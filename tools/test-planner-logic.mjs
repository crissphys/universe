...
// planner.js now powers the tracking page; /planificador uses the galaxy renderer.
const html = fs.readFileSync(new URL('../planificador/seguimiento/index.html', import.meta.url), 'utf8');
