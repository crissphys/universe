(function(){
  ...
  function celebrate(row){
    ...
    id('entrantMessage').innerHTML='<p>Hoy celebramos una meta construida con constancia, disciplina y muchas horas de preparación. <strong>'+safe(row.name)+'</strong>, tu ingreso a <strong>'+safe(row.career)+'</strong> reconoce todo ese esfuerzo y abre una nueva etapa llena de retos, aprendizaje y oportunidades.</p><p>Que este resultado sea el comienzo de una trayectoria universitaria que te permita crecer, aportar y transformar tu entorno. Disfruta este momento junto a las personas que te acompañaron: <strong>bienvenido a la Universidad Nacional de Ingeniería</strong>.</p><div class="entrant-message-signature"><img src="/assets/temario/uni-logo.png" alt="" width="30" height="38"><span><b>Universidad Nacional de Ingeniería</b><small>Lima, Perú</small></span></div>';
