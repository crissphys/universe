(function () {
  ...
  function installUniverseDesignV2() {
    ...
    if (!document.getElementById('uts-design-v2')) {
      ...
      design.href = '/universe-design-v2.css?v=solid-10';
  ...
  function addGoogleAuthStyles() {
    ...
    style.textContent = [
      ...
      '#uts-google-auth-button,[data-uts-account-button="true"]{position:fixed!important;top:max(12px,calc(env(safe-area-inset-top) + 12px))!important;right:max(14px,calc(env(safe-area-inset-right) + 14px))!important;z-index:2147482450!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:.5rem!important;min-height:38px!important;border:1px solid rgba(37,99,235,.22)!important;border-radius:999px!important;background:#fff!important;color:#0f3d75!important;box-shadow:0 12px 30px rgba(15,23,42,.16)!important;padding:.42rem .82rem!important;font:900 .84rem/1 Rajdhani,Inter,system-ui,sans-serif!important;letter-spacing:.4px!important;cursor:pointer!important;white-space:nowrap!important;transition:.2s!important;backdrop-filter:none}',
      ...
      '#uts-google-auth-modal{position:fixed;inset:0;z-index:2147482800;display:none;align-items:center;justify-content:center;padding:18px;background:rgba(2,6,23,.55);backdrop-filter:none}',
      ...
      'html[data-universe-theme="dark"] #uts-google-auth-button,html[data-universe-theme="dark"] [data-uts-account-button="true"]{background:#14243a!important;color:#e5f2ff!important;border-color:rgba(96,165,250,.34)!important;box-shadow:0 14px 34px rgba(0,0,0,.54)!important}',
      ...
      'html[data-universe-theme="dark"] .uts-public-announcement{background:#0e1c30;color:#f8fafc;border-color:rgba(96,165,250,.34);box-shadow:0 24px 70px rgba(0,0,0,.58)}html[data-universe-theme="dark"] .uts-public-announcement p{color:#cbd5e1}html[data-universe-theme="dark"] .uts-public-announcement p a{color:#7dd3fc}html[data-universe-theme="dark"] .uts-public-announcement .uts-ann-like{background:rgba(37,99,235,.14)!important;color:#bfdbfe!important;border-color:rgba(96,165,250,.32)!important}html[data-universe-theme="dark"] .uts-public-announcement .uts-ann-like[aria-pressed="true"]{background:#2563eb!important;color:#fff!important}html[data-universe-theme="dark"] .uts-public-announcement .uts-ann-like-status{color:#94a3b8!important}',
